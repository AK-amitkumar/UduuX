...
class _rml_canvas(object):
    ...
    def _image(self, node):
        ...
        try:
            ...
            s.close()
#        self.contacts_clavem._doc.SaveToFile(self.contacts_clavem._filename, self.contacts_clavem)
...
class TinyDocTemplate(platypus.BaseDocTemplate):
    ...
    def beforeDocument(self):
        # Store some useful value directly inside contacts_clavem, so it's available
